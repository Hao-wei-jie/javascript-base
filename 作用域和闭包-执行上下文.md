...
- this
   ...
   fn1.call({x: 100}, 'zhangsan', 20) // this指向{x: 100},this就是函数的第一个传参,再弹出'zhangsan'
   ...
   fn2.apply({x: 100}, ['zhangsan', 20]) // this指向{x: 100},this就是函数的第一个传参,再弹出'zhangsan'
